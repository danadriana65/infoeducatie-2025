...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        languages = [
            ("C++", "kivy v19/images/ISO_C++_Logo.svg(1).png"), 
            ("Python", "kivy v19/images/Python.svg(1).png"),
            ("JavaScript", "kivy v19/images/1698604163003(1).png")
        ]
    ...
    def open_chat(self, instance):
      if not self.manager.has_screen("chat_screen"):
        self.manager.add_widget(ChatScreen(name="chat_screen"))
